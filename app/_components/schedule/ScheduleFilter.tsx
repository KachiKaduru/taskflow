...
import type { ScheduleFilters } from "@/app/_types";
...
export default function ScheduleFilter() {
  ...
  const handleTypeChange = (event: ChangeEvent<HTMLSelectElement>) => {
    setFilters({ ...filters, type: event.target.value as ScheduleFilters["type"] });
  };

  const handleStatusChange = (event: ChangeEvent<HTMLSelectElement>) => {
    setFilters({ ...filters, status: event.target.value as ScheduleFilters["status"] });
  };
