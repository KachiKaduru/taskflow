...
const ProductivityChart = () => {
  ...
  const { completionData, productivityData, eventDistribution } = useMemo(() => {
    ...
    const parseAppointmentDate = (appointment: AppointmentItem): Date | null => {
    ...
    tasks.forEach((task) => {
      ...
      if (taskDate && taskDate >= lastWeek && taskDate <= today) {
    ...
    events.forEach((event) => {
      ...
      if (eventDate && eventDate >= lastWeek && eventDate <= today) {
    ...
    appointments.forEach((appt) => {
      ...
      if (apptDate && apptDate >= lastWeek && apptDate <= today) {
